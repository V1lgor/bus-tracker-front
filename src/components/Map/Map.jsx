...
import {YMaps, Map, Placemark, RouteEditor, GeoObject, Polygon} from "react-yandex-maps";
...
class Maps extends React.Component {
    ...
    componentDidMount() {
        ...
        let routeCoords = [46.21906120112592, 51.51353207451523,
        ...
        this.setState({stops, routeCoords});
    }
                ...
                <YMaps>
                    <div>
                        <Map defaultState={myStates} className={styles.Map}>
                            ...
                            {this.drawRoute(this.state.routeCoords)}
                            <GeoObject
                                geometry={{
                                    type: 'LineString',
                                    coordinates: [
                                        [51.51353207451523, 46.21906120112592],
                                        [51.51047936999272, 46.218353097946],
                                    ],
                                }}
                                properties={{
                                    hintContent: 'Маршрут 284',
                                    balloonContent: 'Начало 284 маршрута',
                                }}
                                options={{
                                    geodesic: true,
                                    strokeWidth: 3,
